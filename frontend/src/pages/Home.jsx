        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative z-10">
              ...
              <h1 className="animate-fade-up-delay-1 text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight mb-6">
              ...
              {/* Search Box */}
              <form onSubmit={handleSearch} className="animate-fade-up-delay-3 flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <button
                  type="submit"
                  className="hover-glow w-full sm:w-auto px-6 sm:px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-xl transition-all hover:shadow-lg hover:shadow-purple-200"
                >
                  Get help today
                </button>
              </form>
      ...
      <section className="bg-purple-600 py-6 animate-fade-up">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            ...
            <div className="text-purple-200 text-sm w-full lg:w-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
              <button className="px-4 py-2 bg-gray-900 text-white rounded-lg text-sm font-medium flex items-center justify-center gap-2 hover:bg-gray-800 transition w-full sm:w-auto">
      ...
      <section className="bg-purple-600 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="px-6 py-3 bg-gray-900 text-white rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-gray-800 transition w-full sm:w-auto">
